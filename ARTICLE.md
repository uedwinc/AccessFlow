...
**AI Engine**: Amazon Bedrock with Claude 3 Haiku model via the Converse API. I chose Haiku for its balance of quality and cost-effectiveness (~$0.002 per application analysis).
...
1. **Amazon Bedrock**: Core AI generation using Claude 3 Haiku
...
Staying within AWS Free Tier limits. Solution: Selected Claude 3 Haiku model, implemented request throttling, used on-demand DynamoDB billing, and optimized Lambda bundle sizes to reduce execution time.
